        ...
        async function boot() {
            ...
            try {
                const response = await fetch(
                    resolveSitePath("posts/index.json"),
                    { cache: "no-store" },
                );
                if (!response.ok) {
                    throw new Error(
                        "posts/index.json を読み込めませんでした。",
                    );
                }
    ...
    return (
        <div className="app-shell">
                ...
                <main className="panel main">
                    <div>
                        ...
                        <div className="meta">
                            ...
                            <span className={statusClass(status.kind)}>
                                {status.text}
                            </span>
                        </div>
                    </div>
            ...
            <p className="disclosure page-disclosure">
                この サイト の 投稿 と コード は 生成 AI を 用いて
                作成しています。
            </p>
        </div>
    );
